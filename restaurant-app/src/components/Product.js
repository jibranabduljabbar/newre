...
export default function Product(props) {
  ...
  const CheckOut = () => {
    if (count < 1){
      setless("You have to take at least one Item")
     }
    else if (count > 10){
      setless("You can select up to 10 items at a time")
     }
    else if (){
    
    }
      else if (count > 0){
      navigation.navigate("Further Detail")
      setless("")
     }
 ...
 const Upgrade = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={{fontSize: 10,marginTop: 5,textAlign: "center",color: "green",fontWeight: "bold"}}>Price: ${price}</Text>
      <View style={{flexDirection:"row"}}>
      <TouchableOpacity onPress={() => Upgrade()} style={{marginTop: 20,marginBottom: 10,width: 50,padding: 10,backgroundColor: "green"}}>
      ...
      <TouchableOpacity onPress={() => UpgradeS()} style={{marginTop: 20,marginBottom: 10,width: 50,padding: 10,backgroundColor: "red"}}>
        <Text style={{textAlign: "center",fontWeight: "bold",color: "white"}}>-</Text>
      </TouchableOpacity>
      </View>
      ...
      <TouchableOpacity onPress={(props) => CheckOut()} style={{marginTop: 20,marginBottom: 10,width: 130,padding: 10,backgroundColor: "black"}}>
